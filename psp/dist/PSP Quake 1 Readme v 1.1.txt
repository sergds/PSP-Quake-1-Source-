...
If you want to use music playback in Quake 1:
	...
	2. Put files named 02.mp3, 03.mp2 ... 11.mp3 and so on into this directory 
...
examples: 
	...
	-prompt
	(shows a simple startup screen which enables to choose mode game directory, heap size and cpu clock )
...
'-cpu333' will force game to run with cpu clocked to 333 Mhz 

'-cpu222' will force game to run with cpu clocked to 222 Mhz
...
'-heap' allows to change size of internal heap (between 6 and 17 MB)	

'-prompt' option that will show simple startup screen which enables to choose mode game directory, heap size and cpu clock 
